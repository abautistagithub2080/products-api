...
namespace PRODUCTS_API.Data
{
    public class DataLayer
    {
        ...
        public int SSAccDB = int.Parse(cServer._configuration.GetConnectionString("SSAccDB"));
        #pragma warning disable CS8604 // Posible argumento de referencia nulo
        public object? RD;
        private string? DevRootDB()
        {
            string? WSDB = "";
            string WProv = cServer._configuration.GetConnectionString("OLEProv");
            string WProp = cServer._configuration.GetConnectionString("OLEProp");
            var WPath = cServer._hostingEnvironment.ContentRootPath;
